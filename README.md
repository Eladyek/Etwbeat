...
`${GOPATH}/src/github.com/eladyek/Etwbeat`
...
```
git remote set-url origin https://github.com/eladyek/Etwbeat
...
```
mkdir -p ${GOPATH}/src/github.com/eladyek/Etwbeat
git clone https://github.com/eladyek/Etwbeat ${GOPATH}/src/github.com/eladyek/Etwbeat
```
